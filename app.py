...
    /* Custom detailed result box styling (The intended 'others' style) */
    div.stMarkdown > div > div > div[data-testid^="stVerticalBlock"] > div:has(h3) { 
        /* This selector targets the st.markdown output containing the face details */
        background-color: rgba(40, 40, 40, 0.98); 
        border: 1px solid #555; /* Darker border matching the theme */
        border-radius: 0.75rem;
...
        font-size: 1.0rem; /* Ensure consistency with regular paragraph text size */
        text-align: left !important; /* Fix alignment inside the box */
    }
    
